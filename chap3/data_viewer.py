...
class DataViewer:
    def __init__(self):
        ...
        self.plotter.define_input_vector('commands', ['pn_c', 'pe_c', 'h_c', 'Va_c', 'phi_c', 'theta_c', 'chi_c'])
    ...
    def update(self, true_state, estimated_state, commanded_state, delta, ts):
        commands = [commanded_state.north,
                    commanded_state.east,
        ...
        delta_list = [delta.elevator, delta.aileron, delta.rudder, delta.throttle_4]
